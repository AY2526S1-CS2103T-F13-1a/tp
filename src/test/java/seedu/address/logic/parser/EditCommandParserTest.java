...
public class EditCommandParserTest {
    ...
    private static final String MESSAGE_NEGATIVE_INDEX = MESSAGE_NEGATIVE_PERSON_DISPLAYED_INDEX;
    ...
    public void parse_invalidPreamble_failure() {
        ...
        // zero index
        assertParseFailure(parser, "0" + NAME_DESC_AMY, MESSAGE_NEGATIVE_INDEX);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_HANDLE_DESC, Handle.MESSAGE_CONSTRAINTS); // invalid handle
        assertParseFailure(parser, "1" + INVALID_CLOSENESS_DESC, Closeness.MESSAGE_CONSTRAINTS); // invalid closeness
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // profile picture
        userInput = targetIndex.getOneBased() + " " + PREFIX_PROFILE_PICTURE + "example.png";
        descriptor = new EditPersonDescriptorBuilder().withProfilePicture("example.png").build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
